        ...
        <div className="lg:w-3/5 md:w-[55%]">
          ...
          <div>
            ...
            <div className="py-2 flex flex-wrap mb-2 relative">
              ...
              <span className="mx-2 my-2 space-x-1 min-w-24 flex justify-center items-center bg-white px-2 py-1 text-base rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"><FaCss3Alt className="text-blue-500" /> <span>CSS3/SCSS</span></span>
