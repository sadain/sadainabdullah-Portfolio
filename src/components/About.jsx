    ...
    <section id="about-me" aria-labelledby="about-me-title" className="md:py-20 py-10 mb-4 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative" >
      ...
      <div className="flex flex-col lg:flex-row md:flex-row justify-between mx-auto md:mx-0  lg:mx-0">
        <div className="lg:w-3/5 md:w-[55%]">
          ...
          <div>
            ...
            <div className="py-2 flex flex-wrap mb-2 relative">
              <span className="mx-2 my-2 space-x-1 min-w-24 flex justify-center items-center bg-white px-2 py-1 text-base rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"><DiJavascript className="text-yellow-500" /> <span>JavaScript (ES6)</span></span>
              ...
              <span className="mx-2 my-2 space-x-1 min-w-24 flex justify-center items-center bg-white px-2 py-1 text-base rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"><FaCss3Alt className="text-blue-500" /> <span>CSS3/SASS</span></span>
              ...
              <span className="mx-2 my-2 space-x-1 min-w-24 flex justify-center items-center bg-white px-2 py-1 text-base rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"><FaPhp className="text text-indigo-900" /> <span>PHP</span></span>
        ...
        <div className="lg:w-1/3 md:w-2/5 mt-8 lg:mt-0 flex justify-center">
          <div className="md:order-2 h-fit relative before:absolute before:inset-0 before:z-10 before:border before:rounded-xl before:transition before:hover:border-2 before:hover:border-blue-600 before:hover:shadow-lg" >
            <div className="relative overflow-hidden w-full h-fit rounded-xl">
