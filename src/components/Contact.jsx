        ...
        <div className="relative -mx-4 overflow-hidden bg-indigo-50 px-4 py-20 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-3xl md:px-16 xl:px-24 xl:py-36">
          ...
          <div className="relative mx-auto max-w-2xl gap-x-32 gap-y-14 xl:max-w-none items-center">
            ...
            <div className="flex flex-row flex-wrap">
              ...
              <a href='/sadain_abdullah_resume.pdf' target='_blank' className="mt-10 mx-4 px-8 py-2 rounded-md bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200 max-sm:px-4">
