  ...
  return (
    <section className="relative mt-20">
      <div className="z-10 mx-auto relative">
        ...
        <div className="absolute bottom-0 lg:left-[38%] sm:left-20 md:left-48 flex h-8 items-end overflow-hidden"><div className="flex -mb-px h-[5px] w-80 -scale-x-100"><div className="w-full flex-none blur-sm [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"></div><div className="-ml-[100%] w-full flex-none blur-[1px] [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"></div></div></div>
      </div>
      <div className="mx-auto relative min-h max-w-screen-xl px-6 py-2 font-sans md:px-12 md:py-2 lg:px-24 lg:py-0">
        <p className="pt-5 pb-5 xpx-40 text-center font-display text-lg tracking-tight text-blue-900">
