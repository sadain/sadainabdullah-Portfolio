        ...
        <div className='hidden xl:inline-flex w-32 h-full fixed left-0 bottom-0 z-10'>
            <div className='w-full h-full flex flex-col items-center justify-end gap-4 text-textLight'>
                <div className='flex flex-col gap-4'>
                    <a href="https://github.com/sadain" target='_blank'>
                    ...
                    <a href="https://www.linkedin.com/in/sadainabdullah/" target='_blank'>
                    ...
                    <a href="https://www.instagram.com/san_seeker_pi/" target='_blank'>
                    ...
                    <a href="https://twitter.com/sadain314" target='_blank'>
